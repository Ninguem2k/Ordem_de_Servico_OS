...
<html>
    ...
    <body >
        <form action="../Controller/CadastroOS.php" name="formulario" method="POST">
            <div class="os">
                ...
                <div class="row header">  
                    ...
                    <div class="col-6">
                        <div class="aling datn">  
                            <?PHP $SL_os = SELECT('os', 'ID_OS', $_SESSION['ID_OS']); ?>
                            ...
                            ?>
                            <h3>Data de abertura: <input name="Date_OS" type="date" > </h3>
                        </div>
                    </div>
                </div>
                <div class="retagulos"> 
                ...
                <div class="retagulos">
                    ...
                    <div class="aling">
                        <h4>Modelo: <input type="text" name="Modelo" value="" /> </h4>                        
                ...
                <div class="retagulos">
                    ...
                    Desconto: <select name="Desconto" id="Desconto" value="" onchange="Calc_VTotal()" name="Desconto">
                        <option>0</option>
                        <option>1</option>
                        <option>2</option>
                        <option>3</option>
                    ...
                    Atendente: <input type="text" name="Atendente" value="" />
                ...
                <div class="retagulos">
                    ...
                    <a href="../View/Listar_OS.php" style="">
        ...
        <script src="<?PHP echo DIRJS; ?>Cadastro_OS.js"></script>
        <script src="<?PHP echo DIRJS ?>BuscaJS.js"></script>
        <script src="<?PHP echo DIRJS ?>QuantidadeJS.js"></script>
    </body>
</html>
<html>
